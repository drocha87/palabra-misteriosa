const misterious_words = [
	...
	{ word: 'iniciativa', tips: ['capacidad de proponer ideas', 'acción proactiva', 'emprendimiento'] },
	{ word: 'inspiración', tips: ['fuente de creatividad', 'motivación artística', 'ideas nuevas'] },
	{ word: 'inundación', tips: ['exceso de agua', 'ocurre en ríos y ciudades', 'desastre natural'] },
	{ word: 'laboratorio', tips: ['lugar de investigación científica', 'equipado con instrumentos', 'se realizan experimentos'] },
	{ word: 'libertad', tips: ['capacidad de actuar sin restricciones', 'derecho fundamental', 'ausencia de opresión'] },
	{ word: 'manifestación', tips: ['protesta pública', 'reunión de personas', 'puede ser pacífica o violenta'] },
	{ word: 'mecanismo', tips: ['conjunto de partes que funcionan juntas', 'puede ser una máquina', 'sistema operativo'] },
	{ word: 'metodología', tips: ['conjunto de métodos', 'se usa en investigaciones', 'estructura de trabajo'] },
	{ word: 'navegación', tips: ['acción de dirigir un barco', 'puede ser marítima o aérea', 'uso de cartas y mapas'] },
	{ word: 'negociación', tips: ['proceso de llegar a un acuerdo', 'entre dos o más partes', 'puede ser comercial o diplomática'] },
	{ word: 'observación', tips: ['acto de examinar atentamente', 'recolección de datos', 'se usa en ciencia'] },
	{ word: 'organización', tips: ['grupo estructurado con un propósito', 'puede ser una empresa o una ONG', 'tiene una jerarquía'] },
	{ word: 'paradigma', tips: ['modelo o ejemplo a seguir', 'estructura conceptual', 'cambio de perspectiva'] },
	{ word: 'participación', tips: ['acción de tomar parte en algo', 'involucramiento activo', 'puede ser en eventos o decisiones'] },
	{ word: 'percepción', tips: ['proceso de interpretar información sensorial', 'como vemos el mundo', 'puede ser subjetiva'] },
	{ word: 'perspectiva', tips: ['punto de vista', 'forma de entender algo', 'puede cambiar con el tiempo'] },
	{ word: 'preocupación', tips: ['estado de inquietud', 'pensar mucho en algo', 'puede afectar el bienestar'] },
	{ word: 'presidencia', tips: ['cargo de presidente', 'liderazgo de un país', 'administración gubernamental'] },
	{ word: 'productividad', tips: ['eficiencia en la producción', 'medida de rendimiento', 'importante en economía'] },
	{ word: 'programación', tips: ['creación de software', 'escribir código', 'se usa en informática'] },
	{ word: 'proyección', tips: ['predicción a futuro', 'imagen visual en una superficie', 'plan a largo plazo'] },
	{ word: 'reconocimiento', tips: ['acto de identificar algo o a alguien', 'puede ser un premio', 'aprecio por logros'] },
	{ word: 'recreación', tips: ['actividades de ocio', 'tiempo libre', 'puede incluir deportes y juegos'] },
	{ word: 'reflexión', tips: ['pensamiento profundo', 'consideración cuidadosa', 'puede ser filosófica'] },
	{ word: 'relación', tips: ['conexión entre personas o cosas', 'puede ser personal o profesional', 'vínculo afectivo o laboral'] },
	{ word: 'responsabilidad', tips: ['deber u obligación', 'ser responsable de algo', 'asumir consecuencias'] },
	{ word: 'satisfacción', tips: ['sentimiento de placer', 'cumplimiento de expectativas', 'puede ser personal o profesional'] },
	{ word: 'simulación', tips: ['imitación de un proceso real', 'se usa en entrenamiento', 'recreación de escenarios'] },
	{ word: 'sostenibilidad', tips: ['uso responsable de recursos', 'protección del medio ambiente', 'desarrollo a largo plazo'] },
	{ word: 'traducción', tips: ['conversión de un idioma a otro', 'trabajo de traductores', 'puede ser escrita o oral'] }
];
